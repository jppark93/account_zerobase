...
class TransactionServiceTest {
    ...
    void successUseBalance(){
        ...
        AccountUser user = AccountUser.builder()
                ...
                .name("jp")
                .build();
        cAccount account = cAccount.builder()
                .accountUser(user)
        ...
        given(accountRepository.findByAccountNumber(anyString()))
                .willReturn(Optional.of(cAccount.builder()
                        .accountUser(user)
                        .accountStatus(AccountStatus.IN_USE)
                        .balance(10000L)
                        .accountNumber("10000000012")
    ...
    void deleteAccountFailed_userUnMatch() {
        //given
        AccountUser jp = AccountUser.builder()
                .id(12L)
                .name("JP").build();
        ...
        ArgumentCaptor<cAccount> captor = ArgumentCaptor.forClass(cAccount.class);
        //when
        AccountException exception = assertThrows(AccountException.class,
    ...
    void saveFailedUseTransaction(){
        ...
        assertEquals(USE_AMOUNT, captor.getValue().getBalanceSnapshot());
    ...
    @Test
    @DisplayName("원 사용 거래 없음 - 전액 사용 취소 실패")
    ...
    @Test
    @DisplayName("거래와 계좌가 매칭실패 - 전액 사용 실패")
    void cancelTransaction_TransactionAccountUnMatch() {
        ...
        cAccount account = cAccount.builder()
                ...
                .accountNumber("10000000012")
                .build();
        cAccount accountNotUse = cAccount.builder()
                .id(2L)
                .accountUser(user)
                .accountStatus(AccountStatus.IN_USE)
                .balance(10000L)
                .accountNumber("10000000013")
                .build();
        Transaction transaction = Transaction.builder()
                .account(account)
                .transactionType(USE)
    ...
    @Test
    @DisplayName("거래금액과 취소 금액이 다름 - 전액 사용 취소 실패")
    ...
    @Test
    @DisplayName("취소는 1년까지만 가능합니다. - 전액 사용 취소 실패")
